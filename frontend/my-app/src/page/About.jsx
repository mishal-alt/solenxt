...
const About = () => {
    ...
    return (
        <div className="bg-neutral-950 min-h-screen pt-15 pb-20 px-6 relative overflow-hidden selection:bg-cyan-500/30">
            ...
            {/* Hero Section */}
            <section className="text-center py-16 md:py-20 max-w-7xl mx-auto relative z-10">
                ...
                <p className="text-lg md:text-2xl text-gray-500 max-w-4xl mx-auto font-light leading-relaxed tracking-wide italic px-4">
            ...
            <main className="max-w-7xl mx-auto space-y-20 md:space-y-32 relative z-10">
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                    <div className="order-2 md:order-1 space-y-6 md:space-y-8">
                        <div className="inline-block px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[10px] font-bold uppercase tracking-[0.3em] mb-2 md:mb-4">
                            The Foundation
                        </div>
                        <h3 className="text-3xl md:text-5xl font-thin text-white leading-tight uppercase">
                            The Genesis of <span className="font-black">Innovation</span>
                        </h3>
                        <div className="space-y-4 md:space-y-6 text-gray-400 font-light leading-relaxed text-base md:text-lg">
                            <p>
                    ...
                    <div className="order-1 md:order-2 w-full">
                        <div className="bg-white/5 backdrop-blur-xl p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border border-white/10 shadow-2xl relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/10 blur-3xl -z-10 group-hover:bg-cyan-500/20 transition-colors" />
                            <Zap className="w-12 h-12 md:w-16 md:h-16 text-cyan-500 mb-6 md:mb-8 transform group-hover:scale-110 transition-transform" />
                            <p className="text-xl md:text-2xl text-white font-thin italic leading-snug">
                ...
                <div>
                    <h3 className="text-2xl md:text-3xl font-black text-center mb-12 md:mb-16 text-white uppercase tracking-[0.3em] md:tracking-[0.4em]">
                    ...
                    <div className="grid gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                        {coreValues.map((value, index) => (
                            ...
                            >
                                <div className="w-12 h-12 rounded-2xl bg-cyan-500/10 flex items-center justify-center mb-6 group-hover:bg-cyan-500 group-hover:text-black transition-all">
                                    <value.icon className="w-6 h-6" />
                                </div>
                                <h4 className="text-base font-bold mb-4 text-white uppercase tracking-wider">{value.title}</h4>
                                <p className="text-gray-500 text-xs leading-relaxed font-light italic">{value.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="text-center py-16 md:py-20 px-6 bg-white/5 rounded-[2.5rem] md:rounded-[4rem] border border-white/10 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(6,182,212,0.05)_0%,_transparent_70%)]" />
                    <h3 className="text-3xl md:text-5xl font-thin mb-6 text-white uppercase relative z-10 leading-tight">
                        Ready to Discover Your <br className="md:hidden" /> <span className="font-black">Next Sole?</span>
                    </h3>
                    <p className="text-gray-500 mb-10 md:mb-12 max-w-2xl mx-auto font-light tracking-wide relative z-10 text-sm md:text-base italic">
                        Explore our curated collections, dive into the culture, or reach out to our team of dedicated sole experts.
                    </p>
                    <Link to='/product' className="relative z-10 w-full sm:w-auto block">
                        <button className="w-full sm:w-auto px-12 py-5 text-[10px] md:text-sm font-black tracking-[0.3em] text-black bg-white rounded-full shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:bg-cyan-500 hover:text-white transition-all duration-300 uppercase">
                            Shop The Collection
                        </button>
                    </Link>
                </div>

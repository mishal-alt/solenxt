...
function Home() {
    return (
        <div className="bg-neutral-950 min-h-screen relative overflow-hidden selection:bg-cyan-500/30">
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden py-20 md:py-32">
                ...
                <div className="relative z-10 container mx-auto px-6 max-w-7xl">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 md:mb-20 gap-8">
                        ...
                        <Link to="/product" className="group flex items-center gap-3 text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest hover:text-white transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        {[
                            ...
                            <Link to={item.link} key={i} className="group relative block aspect-[4/5] overflow-hidden rounded-[2rem] md:rounded-[3rem] border border-white/10 backdrop-blur-xl transition-all duration-700 hover:border-cyan-500/50">
                                ...
                                <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-between">
                                    <div>
                                        <item.icon className="w-10 h-10 md:w-12 md:h-12 text-cyan-500 mb-6 md:mb-8 transform group-hover:scale-110 transition-transform" />
                                        <div className="space-y-4">
                                            <h3 className="text-2xl md:text-3xl font-thin text-white uppercase leading-tight">
                                                {item.title.split(' ')[0]} <br />
                                                <span className="font-black">{item.title.split(' ')[1]}</span>
                                            </h3>
                                            <p className="text-gray-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">{item.label}</p>
                                        </div>
                                    </div>
                                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-white/20 flex items-center justify-center text-white group-hover:bg-white group-hover:text-black transition-all">
            ...
            <section className="relative min-h-screen flex items-center py-20 md:py-32 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                    <div className="text-center mb-16 md:mb-24 space-y-4">
                        ...
                        <h2 className="text-3xl md:text-6xl font-thin text-white uppercase tracking-[0.1em] md:tracking-[0.2em]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
                        {[
                            ...
                            <div key={i} className="text-center space-y-6 md:space-y-8 group">
                                <div className="mx-auto w-20 h-20 md:w-24 md:h-24 rounded-[1.5rem] md:rounded-[2rem] bg-white/5 backdrop-blur-xl flex items-center justify-center text-cyan-500 shadow-2xl border border-white/10 group-hover:border-cyan-500/50 transition-all duration-500 group-hover:scale-110">
                                    <item.icon className="w-8 h-8 md:w-10 md:h-10" />
                                </div>
                                <div className="space-y-4">
                                    <h4 className="text-lg md:text-xl font-bold text-white uppercase tracking-widest">{item.title}</h4>
                                    <p className="text-gray-400 font-light leading-relaxed text-xs md:text-sm max-w-[280px] mx-auto italic opacity-70 group-hover:opacity-100 transition-opacity">
                                        "{item.desc}"
                                    </p>
                                </div>
                            </div>
            ...
            <section className="relative min-h-[70vh] md:min-h-[90vh] flex items-center justify-center py-24 md:py-40 px-6 text-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                ...
                <div className="relative z-10 w-full max-w-4xl mx-auto">
                    <div className="inline-block px-4 py-1.5 rounded-full bg-cyan-500/5 border border-cyan-500/20 text-cyan-500/50 text-[10px] font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] mb-8 md:mb-12">
                        The Final Frontier
                    </div>
                    <h2 className="text-4xl md:text-9xl font-thin text-white uppercase tracking-[0.2em] md:tracking-[0.3em] mb-10 md:mb-12 leading-tight md:leading-none">
                        YOUR NEXT <br />
                        <span className="font-black tracking-normal">GRAIL AWAITS</span>
                    </h2>
                    <Link to="/product" className="block w-full sm:w-auto">
                        <button className="w-full sm:w-auto group relative px-12 md:px-16 py-5 md:py-6 bg-white text-black font-black text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] rounded-full overflow-hidden hover:bg-cyan-500 hover:text-white transition-all duration-500 shadow-2xl">
